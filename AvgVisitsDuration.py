...
class VisitsDuration(MRJob):
    ...
    def mapper_get_duration(self, _, line):
    ...
    def reducer_avg_duration(self, key, values):
        yield (key, (sum(values)/values))
