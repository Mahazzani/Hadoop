...
def mapper_get_ratings(self, _, line):
    (index, session_id, Type, window_id, browser, device_type, os, host, current_url, referrer, referring_domain, pathname, 
     ...
     duration_hours, duration_minutes, duration_seconds, total_pages, invest) = line.split('\t')
    yield invest, 1
